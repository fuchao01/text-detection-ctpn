...
path = '/data1/sina_recmd/fuchao/github/text-detection-ctpn/data/train/icdar2017rctw_train_v1.2/train'
gt_path = '/data1/sina_recmd/fuchao/github/text-detection-ctpn/data/train/icdar2017rctw_train_v1.2/train'
out_path = 're_image'
